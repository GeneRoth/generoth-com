...
const SITE_DESCRIPTION =
  "AI-assisted compliance advisory for airports, DBEs/ACDBEs, consultants, and concession and construction primes, led by a former FAA compliance director.";
...
export const metadata: Metadata = {
  ...
  description: "AI-assisted compliance advisory for airports, DBEs/ACDBEs, consultants, and concession and construction primes, led by a former FAA compliance director.",
